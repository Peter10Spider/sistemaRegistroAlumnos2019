...
{ 
    $cinco= "El usuario tiene que ser al menos de 5 caracteres"; 
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-5 col-md-5 col-lg-5">
										<div class="form-group">
											...
											<input type="text" id="usuario" class="form-control " required="" placeholder="Escribe el usuario" maxlength="5">
										</div>
									</div>
