				...
				<form id="frmIngreso">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-5">
									<label class="colorLetra"> &nbsp; Cambiar Contraseña</label>
								</div>
								<div class="col-md-3">
									<button type="submit" class="btn btn-login  btn-flat" id="btnRegistro" onclick="location.href='../mRegistro/index.php'">
							...
							<div class="col-md-12">
								...
								<div class="col-md-5" align="center">
									<input id="chkContra"  onchange='evaluarCheck(this.value)' data-on="Si" data-off="No" type="checkbox" checked data-toggle="toggle" data-size="mini" value='no'>
								</div>
							</div>
