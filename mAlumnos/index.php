								...
								<div class="row">
									<div class="col-xs-6 col-sm-5 col-md-5 col-lg-5">
										<div class="form-group">
											...
											<input type="text" id="Ncontrol" class="form-control " required="" placeholder="Escribe el número de control">
										</div>
									</div>
									...
									<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
										<div class="form-group">
											<label for="idCarrera">Seleccione a la carrera:</label>
	      ...
	      <div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
						<div class="form-group">
							<label for="NcontrolE">Número de control:</label>
							<input type="text" id="NcontrolE" class="form-control " required="" placeholder="Escribe el número de control">
						</div>
					</div>
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
						<div class="form-group">
							<label for="idCarreraE">Seleccione a la carrera:</label>
